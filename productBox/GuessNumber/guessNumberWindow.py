...
"font: 12pt \"Agency FB\";")
        ...
        self.action_mute = QtWidgets.QAction(GuessNumber)
...
"③请充分利用数字不能重复和系统返回的猜数字结果，猜想你心中的答案吧。祝你好运！"))
        ...
        self.lineEdit.setPlaceholderText(_translate("GuessNumber", "开始游戏后在这里输入数字..."))
        ...
        self.menu_2.setTitle(_translate("GuessNumber", "选项"))
        ...
        self.action_mute.setText(_translate("GuessNumber", "静音"))
